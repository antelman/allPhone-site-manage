...
export const ORDERDB: OrderDB[] = [
  ...
  },
  {
    order_id: '#51241',
    product: [
      'assets/images/electronics/product/12.jpg',
  ...
  },
  {
    order_id: '#51244',
    product: [
      'assets/images/jewellery/pro/18.jpg',
      'assets/images/fashion/pro/06.jpg',
    ],
    payment_class: 'badge-success',
    payment_status: 'Paid',
    paymeny_method: 'Paypal',
  ...
  },
  {
    order_id: '#51245',
    product: [
      'assets/images/electronics/product/19.jpg',
      'assets/images/electronics/product/20.jpg',
      'assets/images/electronics/product/23.jpg',
    ],
    payment_class: 'badge-success',
    payment_status: 'Paid',
    paymeny_method: 'Visa',
  ...
  },
  {
    order_id: '#51247',
    product: [
      'assets/images/electronics/product/21.jpg',
  ...
  },
  {
    order_id: '#51248',
    product: [
      'assets/images/electronics/product/18.jpg',
      'assets/images/electronics/product/8.jpg',
    ],
    payment_class: 'badge-success',
    payment_status: 'Paid',
  ...
  },
  {
    order_id: '#51251',
    product: [
      'assets/images/electronics/product/22.jpg',
      'assets/images/electronics/product/20.jpg',
    ],
    payment_class: 'badge-secondary',
    payment_status: 'Cash On Delivery',
